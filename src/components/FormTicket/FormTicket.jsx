      ...
      <React.Fragment>
        ...
        <form className="form row" id="firebase-form">
          <div className="form-group col-md-12">
            ...
            />
            <small id="messageValidation" className="form-text text-muted">
              Campo obrigatório!
            </small>
          </div>
          <div className="form-group col-md-12">
          ...
          <div className="form-group col-md-12">
            ...
            >
              ...
              <option value="Smartphones e tablets">
                Smartphones e tablets
              </option>
              <option value="Informática, monitores e acessórios">
                Informática, monitores e acessórios
              </option>
              <option value="Estilo, cultura e entretenimento">
                Estilo, cultura e entretenimento
              </option>
              ...
              <option value="Brinquedos e infantil">
          ...
          <div className="form-group col-md-12">
            ...
            >
              ...
              <option value="Troca diária ou semanal de conteúdo">
                Troca diária ou semanal de conteúdo
              </option>
              <option value="Criação de novo conteúdo">
                Criação de novo conteúdo
              </option>
              <option value="Exclusão de conteúdo">Exclusão de conteúdo</option>
              <option value="Atualização de conteúdo">
                Atualização de conteúdo
              </option>
              <option value="Alteração de conteúdo - Performance baixa">
                Alteração de conteúdo - Performance baixa
              </option>
              <option value="Alteração de conteúdo - Erro de briefing da área Comercial">
                Alteração de conteúdo - Erro de briefing da área Comercial
              </option>
              <option value="Alteração de conteúdo - Erro de briefing da área de Planejamento">
                Alteração de conteúdo - Erro de briefing da área de Planejamento
              </option>
              <option value="Alteração de conteúdo - Erro de briefing da área de Parcerias">
                Alteração de conteúdo - Erro de briefing da área de Parcerias
              </option>
              <option value="Alteração de conteúdo - Erro na arte (Criação)">
                Alteração de conteúdo - Erro na arte (Criação)
              </option>
              <option value="Alteração de conteúdo - Erro de desenvolvimento (Front)">
                Alteração de conteúdo - Erro de desenvolvimento (Front)
              </option>
              <option value="Alteração de conteúdo - Problemas sistêmicos ou operacionais (TI)">
                Alteração de conteúdo - Problemas sistêmicos ou operacionais
                (TI)
              </option>
